package com.evmoter.test.model.common;
...
public class BaseEntity {
    ...
    @ApiModelProperty(notes = "soft delete of the user")
    ...
    public BaseEntity(Long id, LocalDateTime creationDate, LocalDateTime lastModificationDate, Boolean deleteFlag) {
	super();
	this.id = id;
	...
	return "BaseEntity [id=" + id + ", creationDate=" + creationDate + ", lastModificationDate="
		+ lastModificationDate + ", deleteFlag=" + deleteFlag + "]";
    }
